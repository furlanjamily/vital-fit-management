...
/** Showcase estático do hero da landing — não usa sessão real. */
export function HeroProfileShowcase() {
  return (
    <>
          ...
          {challenges.map((challenge) => (
            ...
            >
              ...
              >
                <div
                  className={cn(
                    "grid size-full place-items-center rounded-full bg-white/15 text-[8px] font-bold",
                    glassText.primary,
                  )}
                >
                  {challenge.progress}
